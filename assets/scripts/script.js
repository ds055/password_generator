...
// Create default message for password box
var defaultBoxMsg = "Your Secure Password Will Appear Here"
...
// Resets all object bools to false and empty arrays, so user can re-run app without page reload.
function resetApp() {
...
// Main function to generate password; run on button click
function generatePassword() {
  ...
  if (numOfPassChars === null) return defaultBoxMsg;
